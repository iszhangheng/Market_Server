...
public class MD5SaltTools {
	private static final String HEX_NUMS_STR = "sunlinesunlinesunline";
	...
	public static String commonMd5(String password) {
	 ...
	 * System.out.println(commonMd5("123456")); }
	 */
